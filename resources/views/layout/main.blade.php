...
<nav class=" p-4 rounded-b-xl fixed top-0 w-full z-40 mb-1">
  <div class="mx-auto">
    <div class="flex justify-between items-center">
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-4"> 
          ...
          <li><button class="rounded-full text-white bg-gradient-to-r from-indigo-500 via-purple-500  p-2 pr-3 pl-3 outline outline-2 outline-offset-2">Register</button></li>
        </ul>
        </div>
    </div>
  </div>
